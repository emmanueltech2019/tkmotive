...
import heroImg from './components/img/pexels-shkrabaanthony-6759181.jpg'
  ...
  return (
    <div>
      <div className="z-50 fixed left-1/2 transform -translate-x-1/2 w-full inset-0 flex items-center justify-center bg-black bg-opacity-50">
        <div className="relative left-[-120px] -top-[60px]  md:right-[10%] text-6xl md:text-[95px] font-bold w-[10%] m-auto">
